...
pub const  COMMA_SPLIT_PATTERN:Regex = Regex::new("\\s*[,]+\\s*").unwrap();

pub const PATH_SEPARATOR:&str = "/";

pub const PROTOCOL_SEPARATOR:&str = "://";

pub const PROTOCOL_SEPARATOR_ENCODED:&str = Url.encode(PROTOCOL_SEPARATOR);

pub const REGISTRY_SEPARATOR:&str = "|";

pub const  REGISTRY_SPLIT_PATTERN:Regex = Regex::new("\\s*[|;]+\\s*").unwrap();

pub const  D_REGISTRY_SPLIT_PATTERN:Regex = Regex::new("\\s*[|]+\\s*").unwrap();

pub const SEMICOLON_SEPARATOR:&str = ";";

pub const SEMICOLON_SPLIT_PATTERN:Regex = Regex::new("\\s*[;]+\\s*").unwrap();

pub const EQUAL_SPLIT_PATTERN:Regex = Regex::new("\\s*[=]+\\s*").unwrap();
...
pub const DEFAULT_THREAD_NAME:&str = "Dubbo";

pub const DEFAULT_CORE_THREADS:usize = 0;

pub const DEFAULT_THREADS:usize = 200;

pub const CONSUMER_SHARED_EXECUTOR_SERVICE_COMPONENT_KEY:&str = "CONSUMER_SHARED_SERVICE_EXECUTOR";

pub const INTERNAL_EXECUTOR_SERVICE_COMPONENT_KEY:&str = "INTERNAL_SERVICE_EXECUTOR";
...
pub const THREAD_POOL_EXHAUSTED_LISTENERS_KEY:&str = "thread-pool-exhausted-listeners";
